<template>
    <div class="myHeader">
        <span>
            <svg t="1710426365171" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                p-id="12416" width="30" height="30">
                <path
